...
<div class="form-group">
    ...
    <p class="help-block"><?= t('Full cards use the shared Express entries and group them by section. Compact mode is intended for the homepage and can still use the curated block items saved on that block.') ?></p>
</div>
