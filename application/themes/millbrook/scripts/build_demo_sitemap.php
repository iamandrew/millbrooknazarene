...
$tree = [
    [
        ...
        'content' => <<<'HTML'
<h2>Thinking About Visiting?</h2>
<p>We know visiting a church can feel like a big step, especially if you are not sure what to expect. Whether you are new to Larne, new to church, returning after a while, or just quietly curious, you would be very welcome at Millbrook.</p>
...
<ul>
  ...
  <li>Worship, prayer, Bible reading, and a short talk</li>
  <li>A service that is accessible whether church feels familiar or not at all</li>
...
HTML,
    ...
    [
        ...
        'handle' => 'community',
        'aliases' => ['ministries'],
        'description' => 'See how church life extends beyond Sunday through community, care, and shared life.',
        'content' => <<<'HTML'
<h2>In The Heart Of The Community</h2>
<p>Millbrook exists to be a faithful, loving presence in Larne. Alongside Sunday worship, church life includes children and families, homegroups, prayer, pastoral care, and regular opportunities to share life together.</p>

<h3>Explore Community Life</h3>
<ul>
...
HTML,
            ...
            [
                'name' => $womensMinistryContent['name'],
                'handle' => 'womens-ministry',
                'aliases' => ['women'],
                'description' => $womensMinistryContent['description'],
                'content' => $womensMinistryContent['content'],
            ],
            [
                'name' => $crecheContent['name'],
                'handle' => 'creche',
                'description' => $crecheContent['description'],
                'content' => $crecheContent['content'],
            ],
        ],
    ],
    [
    ...
    [
        ...
        'children' => [
            [
                ...
                'content' => <<<'HTML'
<p>Catch up on Sunday sermons and Bible teaching from Millbrook. Whether you missed a gathering or want to revisit a message during the week, you can listen here or continue on Spotify or Apple Podcasts.</p>
HTML,
            ],
            [
                'name' => 'Rotas',
...
<div class="content-intro">
  <p>You can use the document library on this page to access important church policies, safeguarding information, and other key documents.</p>
</div>
HTML,
            ],
        ],
...
$obsoletePage = Page::getByPath('/about/faqs', 'ACTIVE');
if ($obsoletePage instanceof Page && !$obsoletePage->isError()) {
    $obsoletePage->delete();
    $output->writeln('Deleted obsolete page: /about/faqs');
}
