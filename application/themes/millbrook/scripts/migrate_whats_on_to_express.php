...
function whats_on_seed_items(): array
{
    return [
        ...
        [
            ...
            'detail_when' => 'Sunday evenings and Wednesday evenings',
            'detail_where' => 'In homes; address shared privately',
            'detail_for' => 'Anyone looking for a smaller place to connect',
            'detail_first_time' => 'Contact us before attending so we can confirm the group, rhythm, and address.',
        ...
        [
            ...
            'detail_first_time' => 'Speak to Megan or Irene, or send us a message to check the next date.',
